...
Task 2: _calloc - A function that allocates memory for an array, using malloc.
...
Task 4: _realloc - A function that reallocates a memory block using malloc and free
